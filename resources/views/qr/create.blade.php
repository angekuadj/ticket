...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Genérer un nouvel uilisateur ainsi que son QRCode</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('qr.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">nombre_visiteur </label>

                            <div class="col-md-6">
                                <input  type="number" class="form-control" name="nombre_visiteur" required>
                            </div>
                        </div>
